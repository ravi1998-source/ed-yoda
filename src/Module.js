...
import './Module.css'
import ModuleSideOp from './ModuleSideOp'
        ...
        <div className="module">
            <div className="module__sidebar">
                ...
                <Link to="/java">
                    <Button>
                    <ModuleSideOp
                       icon="https://wp.sitepen.com/wp-content/uploads/2016/04/js.png"
                       title="Javascript" />
                    </Button>   
                </Link>
            </div>
